  ...
  return (
    <>
      ...
      <div className="mt-12 bg-blue-50 rounded-lg p-8 text-center border-2 border-blue-200">
        ...
        <p className="text-gray-600 mb-6">使用我们的计算器工具，快速计算装修材料用量</p>
        <div className="flex flex-col sm:flex-row gap-4 justify-center">
          <Link href="/calculators/paint" className="bg-blue-600 text-white px-6 py-3 rounded-lg font-semibold hover:bg-blue-700 transition">
            油漆计算器
          </Link>
          <Link href="/calculators/tile" className="bg-white text-blue-600 px-6 py-3 rounded-lg font-semibold border-2 border-blue-600 hover:bg-blue-50 transition">
            瓷砖计算器
          </Link>
          <Link href="/calculators/flooring" className="bg-white text-blue-600 px-6 py-3 rounded-lg font-semibold border-2 border-blue-600 hover:bg-blue-50 transition">
            地板计算器
          </Link>
        </div>
      </div>
